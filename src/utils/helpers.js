...
export function setupSounds() {
	let soundsObj = {
		...
		bookLatch: createjs.Sound.createInstance("book-latch"),
		bookOpen: createjs.Sound.createInstance("book-open"),
		boxClose: createjs.Sound.createInstance("box-close"),
		cardOver0: createjs.Sound.createInstance("opening-card-over"),
		cardOver1: createjs.Sound.createInstance("opening-card-over"),
		cardOver2: createjs.Sound.createInstance("opening-card-over"),
		cardOver3: createjs.Sound.createInstance("opening-card-over"),
		cardOver4: createjs.Sound.createInstance("opening-card-over"),
		cardsDissipate: createjs.Sound.createInstance("cards-dissipate"),
		collectionManager: createjs.Sound.createInstance("collection-manager"),
		pickupCard: createjs.Sound.createInstance("pickup-card"),
		...
		floatyOver: createjs.Sound.createInstance("floaty-over"),
		...
		pageForward: createjs.Sound.createInstance("page-forward"),
		pageBack: createjs.Sound.createInstance("page-back"),
